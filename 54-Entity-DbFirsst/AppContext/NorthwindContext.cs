...
namespace _54_Entity_DbFirsst.AppContext
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<VwSipariRaporlari> VwSipariRaporlaris { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VwSipariRaporlari>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_SipariRaporlari");
